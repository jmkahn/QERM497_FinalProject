...
# %% 
# test run_simulation 
results_dict = run_simulation(m=0.8, L=10, t_steps=5, d=2, init_grass=0.1, init_tree=0.1, p_gro_gmax = 0.01, p_lightning=0.001, r_spr_tmax=0.7, r_spr_gmax=0.5, r_cat_tmax=0.3, r_cat_gmax=0.7, output_times=[0, 1, 2, 3, 4])
